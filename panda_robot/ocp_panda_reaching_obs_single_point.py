...
from soft_constraint_cost import CostModelPairCollision
# from residualDistanceCollision import ResidualCollision
...
class OCPPandaReachingColWithSingleCol:
    ...
    def __call__(self) -> Any:
        ...
        # collision_cost = CostModelPairCollision(self._state, self._cmodel, self._cdata, 0,7)
        ...
        # obstacleDistanceCost2 = crocoddyl.CostModelResidual(
        #     self._state,xLimitActivation ,obstacleDistanceResidual2
        # )
        ...
        # self._runningCostModel.addCost("colcostrm", obstacleDistanceCost2, 1000)
        ...
        # self._terminalCostModel.addCost("colcosttm", obstacleDistanceCost2, 1000)
