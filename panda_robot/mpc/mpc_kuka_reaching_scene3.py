...
# Robot simulator
robot_simulator = PandaRobot(obstacle_dim=OBSTACLE_DIM, obstacle_pose=OBSTACLE_POSE, obstacle_shape="capsule")
...
OBSTACLE_HALFLENGTH = robot_simulator.pin_robot.collision_model.geometryObjects[
    robot_simulator.pin_robot.collision_model.getGeometryId("obstacle")
].geometry.halfLength
dt = 2e-2
T = 8
...
mpc_utils.display_capsule(
    OBSTACLE_POSE.translation, length = OBSTACLE_HALFLENGTH *2, RADIUS=OBSTACLE_DIM, COLOR=[1.0, 1.0, 0.0, 0.6]
)
