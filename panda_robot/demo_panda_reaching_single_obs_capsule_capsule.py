...
from utils import BLUE, YELLOW_FULL, RED_FULL, GREEN_FULL, BLUE_FULL
...
cmodel.addCollisionPair(
    pin.CollisionPair(cmodel.getGeometryId("panda2_link6_capsule"), IG_OBSTACLE)
)
cmodel.addCollisionPair(
    pin.CollisionPair(cmodel.getGeometryId("panda2_link5_capsule"), IG_OBSTACLE)
)
cmodel.addCollisionPair(
    pin.CollisionPair(cmodel.getGeometryId("panda2_link7_capsule"), IG_OBSTACLE)
)
cmodel.addCollisionPair(
    pin.CollisionPair(cmodel.getGeometryId("panda2_link7_capsule1"), IG_OBSTACLE)
)
cdata = cmodel.createData()
