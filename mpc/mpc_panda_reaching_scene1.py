...
if WITH_SAVING_RESULTS:
    ...
    with open("results/scene1/comparingcsqpfddpsqp/" + "nnodes" + str(T) + "fdt" + str(int(1/dt)) + "maxit" + str(max_iter) + "maxqpiters" + str(max_qp_iters) + "csqp" + ".json", "w") as outfile:
